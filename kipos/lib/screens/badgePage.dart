...
class BadgePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
          child: (verified().toString() == 'stop')
              ? Consumer<DatabaseRepository>(builder: (context, value, child) {
...
CO2 absorbed: 1170kg''';
                                ...
                                FlipCard(
                                    ...
                                    front: Container(
                                      child: BadgeCard(
                                        ...
                                        urlImmagine:
                                            image_week1, //IMMAGINE CHE CAMBIA
                                      ),
                                    ),
                                    back: Center(
                                        child: Container(
                                      child: Center(
                                        child: Padding(
                                            padding: EdgeInsets.fromLTRB(
                                                20, 20, 20, 20),
                                            child: Text(
                                                sentence_week1, //TESTO CHE CAMBIA
                                ...
                                FlipCard(
                                    ...
                                    front: Container(
                                      child: BadgeCard(
                                        ...
                                        urlImmagine:
                                            image_week2, //IMMAGINE CHE CAMBIA
                                      ),
                                    ),
                                    back: Center(
                                        child: Container(
                                      child: Center(
                                        child: Padding(
                                            padding: EdgeInsets.fromLTRB(
                                                20, 20, 20, 20),
                                            child: Text(
                                                sentence_week2, //TESTO CHE CAMBIA
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: 15))),
                                ...
                                FlipCard(
                                    ...
                                    front: Container(
                                      child: BadgeCard(
                                        ...
                                        urlImmagine:
                                            image_week3, //IMMAGINE CHE CAMBIA
                                      ),
                                    ),
                                    back: Center(
                                        child: Container(
                                      child: Center(
                                        child: Padding(
                                            padding: EdgeInsets.fromLTRB(
                                                20, 20, 20, 20),
                                            child: Text(
                                                sentence_week3, //TESTO CHE CAMBIA
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: 15))),
                                ...
                                FlipCard(
                                    ...
                                    front: Container(
                                      child: BadgeCard(
                                        ...
                                        urlImmagine:
                                            image_week4, //IMMAGINE CHE CAMBIA
                                      ),
                                    ),
                                    back: Center(
                                        child: Container(
                                      child: Center(
                                        child: Padding(
                                            padding: EdgeInsets.fromLTRB(
                                                20, 20, 20, 20),
                                            child: Text(
                                                sentence_week4, //TESTO CHE CAMBIA
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: 15))),
                                ...
                                FlipCard(
                                    ...
                                    front: Container(
                                      child: BadgeCard(
                                        titolo: '''Week 5 - Guava''',
                                        urlImmagine:
                                            image_week5, //IMMAGINE CHE CAMBIA
                                      ),
                                    ),
                                    back: Center(
                                        child: Container(
                                      child: Center(
                                        child: Padding(
                                            padding: EdgeInsets.fromLTRB(
                                                20, 20, 20, 20),
                                            child: Text(
                                                sentence_week5, //TESTO CHE CAMBIA
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: 15))),
                                ...
                                FlipCard(
                                    ...
                                    front: Container(
                                      child: BadgeCard(
                                        ...
                                        urlImmagine:
                                            image_week6, //IMMAGINE CHE CAMBIA
                                      ),
                                    ),
                                    back: Center(
                                        child: Container(
                                      child: Center(
                                        child: Padding(
                                            padding: EdgeInsets.fromLTRB(
                                                20, 20, 20, 20),
                                            child: Text(
                                                sentence_week6, //TESTO CHE CAMBIA
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: 15))),
                                ...
                                FlipCard(
                                    ...
                                    front: Container(
                                      child: BadgeCard(
                                        ...
                                        urlImmagine:
                                            image_week7, //IMMAGINE CHE CAMBIA
                                      ),
                                    ),
                                    back: Center(
                                        child: Container(
                                      child: Center(
                                        child: Padding(
                                            padding: EdgeInsets.fromLTRB(
                                                20, 20, 20, 20),
                                            child: Text(
                                                sentence_week7, //TESTO CHE CAMBIA
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: 15))),
                                ...
                                FlipCard(
                                    ...
                                    front: Container(
                                      child: BadgeCard(
                                        ...
                                        urlImmagine:
                                            image_week8, //IMMAGINE CHE CAMBIA
                                      ),
                                    ),
                                    back: Center(
                                        child: Container(
                                      child: Center(
                                        child: Padding(
                                            padding: EdgeInsets.fromLTRB(
                                                20, 20, 20, 20),
                                            child: Text(
                                                sentence_week8, //TESTO CHE CAMBIA
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: 15))),
                                ...
                                FlipCard(
                                    ...
                                    front: Container(
                                      child: BadgeCard(
                                        ...
                                        urlImmagine:
                                            image_week9, //IMMAGINE CHE CAMBIA
                                      ),
                                    ),
                                    back: Center(
                                        child: Container(
                                      child: Center(
                                        child: Padding(
                                            padding: EdgeInsets.fromLTRB(
                                                20, 20, 20, 20),
                                            child: Text(
                                                sentence_week9, //TESTO CHE CAMBIA
                                                textAlign: TextAlign.center,
                                                style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: 15))),
                                ...
                                FlipCard(
                                    ...
                                    front: Container(
                                      child: BadgeCard(
                                        ...
                                        urlImmagine:
                                            image_week10, //IMMAGINE CHE CAMBIA
                                      ),
                                    ),
                                    back: Center(
                                        child: Container(
                                ...
                                FlipCard(
                                    ...
                                    front: Container(
                                      child: BadgeCard(
                                        ...
                                        urlImmagine:
                                            image_week11, //IMMAGINE CHE CAMBIA
                                      ),
                                    ),
                                    back: Center(
                                        child: Container(
                                ...
                                FlipCard(
                                    ...
                                    front: Container(
                                      child: BadgeCard(
                                        titolo: '''Week 12 - Neem''',
                                        urlImmagine:
                                            image_week12, //IMMAGINE CHE CAMBIA
                                      ),
                                    ),
                                    back: Center(
                                        child: Container(
                                ...
                                FlipCard(
                                    ...
                                    front: Container(
                                      child: BadgeCard(
                                        ...
                                        urlImmagine:
                                            image_week13, //IMMAGINE CHE CAMBIA
                                      ),
                                    ),
                                    back: Center(
                                        child: Container(
                                ...
                                FlipCard(
                                    ...
                                    front: Container(
                                      child: BadgeCard(
                                        ...
                                        urlImmagine:
                                            image_week14, //IMMAGINE CHE CAMBIA
                                      ),
                                    ),
                                    back: Center(
                                        child: Container(
                                ...
                                FlipCard(
                                    ...
                                    front: Container(
                                      child: BadgeCard(
                                        ...
                                        urlImmagine:
                                            image_week15, //IMMAGINE CHE CAMBIA
                                      ),
                                    ),
                                    back: Center(
                                        child: Container(
                                ...
                                FlipCard(
                                    ...
                                    front: Container(
                                      child: BadgeCard(
                                        ...
                                        urlImmagine:
                                            image_week16, //IMMAGINE CHE CAMBIA
                                      ),
                                    ),
                                    back: Center(
                                        child: Container(
              ...
              : const Text("You have to authorise data first!")),
